            ...
            <div className="relative w-full h-full max-w-2xl md:h-auto">
              ...
              <div className="relative bg-white rounded-lg shadow">
                ...
                <div className="px-6 py-6">
                  <h3 className="mb-4 text-xl font-medium text-gray-900">TopicPostにログインする</h3>
                    ...
                    <div className="h-auto max-w-full border-l-2 pl-6">
                      <form className="space-y-6" action="#">
                        <div>
                          ...
                          <input type="email" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="example@topicpost.net" required />
                        </div>
                        <div>
