  ...
  return (
    <footer className="fixed bottom-0 left-0 z-20 w-full p-4 bg-white border-t border-gray-200">
      <ul className="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
        <li>
          <a href="#" target="_blank" className="flex mr-4 hover:underline md:mr-6 ">
        ...
        <li>
          <a href="https://github.com/topics/topicpost" className="mr-4 hover:underline md:mr-6">Privacy Policy</a>
        </li>
      </ul>
