      ...
      <ReactMarkdown
        ...
        components={{
          h1: ({ node, children, ...props }) => (
            <div className="font-bold mb-2 text-3xl" {...props}>
              {children || ''}
            </div>
          ),
          ...
          h4: ({ node, children, ...props }) => (
            <h4 className="m-0 font-bold mb-2 text-lg" {...props}>
              {children || ''}
            </h4>
          ),
          h5: ({ node, children, ...props }) => (
            <h5 className="m-0 mb-2 text-base" {...props}>
              {children || ''}
            </h5>
          ),
          h6: ({ node, children, ...props }) => (
            <h6 className="m-0 mb-2 text-sm" {...props}>
              {children || ''}
            </h6>
          ),
          p: ({ node, ...props }) => (
          ...
          code: ({ node, inline, className, children, ...props }) => {
            return inline ? (
              ...
              <pre className="bg-gray-800 text-gray-200 p-3 text-sm m-0 rounded" {...props}>
                {children}
              </pre>
            )
          },
