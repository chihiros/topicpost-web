      ...
      <div className="p-4 shadow-md bg-gray-50 rounded-lg">
        ...
        <form>
          ...
          <div className="flex items-start mb-6">
            ...
            <label htmlFor="terms" className="ml-2 text-sm font-medium text-gray-900">I agree with the <a href="/contact" className="text-blue-600 hover:underline">terms and conditions</a></label>
          </div>
          <div className="mb-6">
