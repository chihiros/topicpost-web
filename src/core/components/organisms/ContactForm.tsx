      ...
      <div className="p-4 shadow-md bg-gray-50 rounded-lg">
        ...
        <form>
          ...
          <div className="mb-6">
            ...
            <textarea id="message" rows={4} className="p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Leave a comment..." required></textarea>
          </div>
